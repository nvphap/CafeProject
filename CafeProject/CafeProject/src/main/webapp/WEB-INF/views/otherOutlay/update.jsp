						...
						<div class="well with-header  with-footer">
                            ...
                            <div class="table-responsive" align="center" style="width: 100%; display: inline-block; border:1px;">
                            	<form:form method="POST" id="submitForm" 
									action="${pageContext.request.contextPath}/otherOutlay/update/request"
									...
									<div class="form-group">
										<form:input  path="sn" type="hidden"/>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<form:input path="timeTransactionStr" id="timeTransactionStr" readonly="true" class="form-control"></form:input>
										</div>
									</div>
