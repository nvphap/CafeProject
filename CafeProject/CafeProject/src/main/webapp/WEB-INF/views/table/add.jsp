				...
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-xs-12">
						...
						<div class="well with-header  with-footer">
                            <div class="header bg-magenta"><spring:message code="cafeTable.addTitle" /></div>
                            ...
                            <div class="table-responsive" align="center" style="width: 100%; display: inline-block; border:1px;" id="staff_update_content">
                            	<form:form method="POST" id="submitForm" 
									action="${pageContext.request.contextPath}/table/add/request"
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<form:input type="text" id="location" path="location"
												class="form-control" placeholder="${cafeTable_location}" required="required" 
												maxlength="256"/>
										</div>
									</div>
