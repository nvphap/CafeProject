				...
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<h5 class="row-title before-magenta">
							...
							<spring:message code="food.updateFoodUnitTitle"/>
						</h5>
						<div class="widget">
						...
						<div class="well with-header  with-footer">
                            <div class="header bg-magenta"><spring:message code="food.updateFoodUnitTitle" /></div>
                            ...
                            <div class="table-responsive" align="center" style="width: 100%; display: inline-block; border:1px;" id="staff_update_content">
                            	<form:form method="POST" id="submitForm" 
									action="${pageContext.request.contextPath}/foodUnit/update/request"
