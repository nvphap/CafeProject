				...
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<h5 class="row-title before-magenta">
							...
							<spring:message code="food.updateTitle"/>
						</h5>
						<div class="widget">
						...
						<div class="well with-header  with-footer">
                            <div class="header bg-magenta"><spring:message code="food.updateTitle" /></div>
                            ...
                            <div class="table-responsive" align="center" style="width: 100%; display: inline-block; border:1px;" id="staff_update_content">
                            	<form:form method="POST" id="submitForm" 
									action="${pageContext.request.contextPath}/food/update/request"
									...
									<form:input type="hidden" path="sn" required="required"/>
									...
									<div class="form-group">
										...
										<div class="col-md-6" style="text-align:left;">
											<c:if test="${1==food.publicRecipes}">
											<input id="publicRecipes" name="publicRecipes" type="checkbox" checked="checked"
